...
<body>
    ...
    <div class="contenedor-medios">
        <div class="medio" id="libertaddigital">
            <h2>LibertadDigital</h2>
            <div class="noticias">
                <!-- Aquí se mostrarán las noticias de Libertad Digital -->
            </div>
        </div>
    ...
    <script>
                          ...
                          data.items.forEach(item => {
                              ...
                              noticia.innerHTML = `
                                  ...
                                  <div class="info">
                                    ...
                                    <p class="author">Autor: ${item.author}</p>
                                  </div>
                              `;
        ...
        document.addEventListener("DOMContentLoaded", function() {
          Medios.cargarNoticias('https://api.rss2json.com/v1/api.json?rss_url=https://feeds2.feedburner.com/libertaddigital/opinion', 'libertaddigital');
          Medios.cargarNoticias('https://api.rss2json.com/v1/api.json?rss_url=https://feeds.elpais.com/mrss-s/list/ep/site/elpais.com/section/opinion', 'elpais');
          Medios.cargarNoticias('https://api.rss2json.com/v1/api.json?rss_url=https://rss.blogs.elconfidencial.com/', 'elconfidencial');
        });
    </script>
</body>
</html>
