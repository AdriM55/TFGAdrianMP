...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
          Medios.cargarNoticias('https://api.rss2json.com/v1/api.json?rss_url=https://e00-elmundo.uecdn.es/elmundo/rss/espana.xml', 'elmundo');
          Medios.cargarNoticias('https://api.rss2json.com/v1/api.json?rss_url=https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/portada', 'elpais');
          Medios.cargarNoticias('https://api.rss2json.com/v1/api.json?rss_url=https://rss.elconfidencial.com/espana/', 'elconfidencial');
        });
    </script>
</body>
</html>
